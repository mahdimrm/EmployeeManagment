    ...
    public static class TextTools
    {
        public static string ToPersianDate(this DateTime dateTime)
        {
            try
            {
                ...
                string time = $"{pc.GetYear(dateTime)}/{pc.GetMonth(dateTime)}/{pc.GetDayOfMonth(dateTime)}";
                return time;
            }
            catch (Exception)
            {
        ...
        public static string ToGregorianDate(this DateTime dateTime, string format = "yyyy/MM/dd")
        {
            try
            {
        ...
        public static DateTime ToDateTime(this string initialValue)
        {

            int pos = initialValue.IndexOf("/");
            string dFormat = pos == 2 ? "MM/yyyy/dd" : "yyyy/MM/dd";
            DateTime dTime = DateTime.MinValue;
            DateTime.TryParseExact(initialValue, dFormat,
                CultureInfo.GetCultureInfo("fa-IR"), DateTimeStyles.None, out dTime);
